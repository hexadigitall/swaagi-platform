...
#### Primary Logo
- **File**: `logos/swaagi-logo-primary.svg`
...
--swaagi-gold-500: #D4AF37;
--swaagi-gold-600: #B8860B;
--swaagi-gold-700: #9A7209;

/* Deep Blue - Global Style */
--swaagi-blue-700: #1E3A8A;
--swaagi-blue-800: #1E40AF;
--swaagi-blue-900: #1E3A8A;
```

#### Secondary Colors
```css
/* Earth Tones - Sustainability */
--swaagi-earth-400: #A3A3A3;
--swaagi-earth-500: #737373;
--swaagi-earth-600: #525252;

/* Accent Colors - International Vibrancy */
--swaagi-coral-500: #F97316;
--swaagi-emerald-500: #10B981;
--swaagi-purple-500: #8B5CF6;
```

#### Global Pattern Colors
- **Modern-inspired**: Gold, red, green, black
- **International patterns**: Bold contrasting colors
...
```
swaagi-[asset-type]-[variation]-[size].[extension]

Examples:
swaagi-logo-primary-large.svg
swaagi-pattern-modern-subtle.png
swaagi-color-palette-primary.pdf
```
